...
-- Políticas RLS para rides - Admins podem ver tudo
DO $$ BEGIN
...
-- Passageiros podem atualizar suas corridas
DO $$ BEGIN
...
-- Passageiros podem visualizar suas corridas
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE polname='Passengers can view their rides' AND tablename='rides') THEN
...
-- Motoristas podem aceitar corridas pendentes
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE polname='Drivers can accept pending rides' AND tablename='rides') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE polname='Admins can view all ratings' AND tablename='ride_ratings') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE polname='Users can create ratings for their rides' AND tablename='ride_ratings') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE polname='Users can view ratings they gave or received' AND tablename='ride_ratings') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE polname='Admins can view all driver passenger ratings' AND tablename='driver_passenger_ratings') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE polname='Users can create driver passenger ratings for their rides' AND tablename='driver_passenger_ratings') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE polname='Users can view driver passenger ratings for their rides' AND tablename='driver_passenger_ratings') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE polname='Drivers can view their payout requests' AND tablename='driver_payout_requests') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE polname='Admins can view all driver balances' AND tablename='driver_balances') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE polname='Admins can view all fee payments' AND tablename='fee_payments') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE polname='Admins can update fee payments' AND tablename='fee_payments') THEN
